    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (userID) {
            case ("areniegojanjonelle19@gmail.com"):
                reference = FirebaseDatabase.getInstance().getReference("AW0001delivered");
            ...
            case ("gremember1@gmail.com"):
                reference = FirebaseDatabase.getInstance().getReference("AW0002delivered");
                reference.addValueEventListener(new ValueEventListener() {
            ...
            case ("mikemanalo@gmail.com"):
                reference = FirebaseDatabase.getInstance().getReference("AW0003delivered");
                reference.addValueEventListener(new ValueEventListener() {
